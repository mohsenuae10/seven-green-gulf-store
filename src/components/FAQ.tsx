...
const FAQ = () => {
  ...
  const faqs = language === 'ar' ? [
    {
      question: "ما هي فوائد صابونة سفن جرين للشعر؟",
      answer: "صابونة سفن جرين تحتوي على 7 أعشاب طبيعية صينية تعمل على منع تساقط الشعر بنسبة 85%، زيادة كثافة الشعر بنسبة 97%، التحكم في الزيوت الزائدة، وزيادة اللمعان الطبيعي بنسبة 92%. شامبو سفن جرين مناسب لجميع أنواع الشعر وآمن للاستخدام اليومي."
    },
    {
    ...
    {
      question: "هل منتج سفن جرين آمن ومناسب لجميع أنواع الشعر؟",
      answer: "نعم، صابونة سفن جرين مصنوعة من مكونات طبيعية 100% وخالية تماماً من المواد الكيميائية الضارة. تم اختبار شامبو سفن جرين طبياً وهو آمن للاستخدام على جميع أنواع الشعر بما في ذلك الشعر المصبوغ والمعالج كيميائياً."
    },
    {
      question: "كيف أستخدم صابونة سفن جرين؟",
      answer: "بلل شعرك بالماء الدافئ، ثم افرك صابونة سفن جرين بلطف على فروة الرأس والشعر حتى يتكون رغوة غنية. دلك فروة الرأس بحركات دائرية لمدة 2-3 دقائق لتحفيز الدورة الدموية، ثم اشطف شامبو سفن جرين جيداً بالماء. للحصول على أفضل النتائج، استخدم سفن جرين مرتين يومياً."
    },
    {
    ...
    },
    {
      ...
      answer: "صابونة سفن جرين تتميز بتركيبة فريدة من 7 أعشاب صينية طبيعية عمرها أكثر من 2000 عام. شامبو سفن جرين طبيعي 100%، خالٍ من المواد الكيميائية، ومختبر طبياً. كما حقق سفن جرين نتائج مثبتة علمياً: 97% تحسن في الكثافة، 85% تقليل التساقط، و92% زيادة في اللمعان."
    },
    {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 animate-slide-up">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            {language === 'ar'
              ? 'إجابات على الأسئلة الأكثر شيوعاً حول صابونة وشامبو سفن جرين'
