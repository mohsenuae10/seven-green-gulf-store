              ...
              {language === 'ar' ? (
                <>
                  <p className="mb-4 leading-relaxed">
                    بدأت رحلة سفن جرين في عام 2020 من قلب المملكة العربية السعودية، عندما لاحظنا حاجة ملحة لمنتجات عناية بالشعر طبيعية وفعالة في السوق السعودي. كانت معظم المنتجات المتوفرة إما محملة بمواد كيميائية ضارة أو غير فعالة في معالجة مشاكل تساقط الشعر.
                  </p>
                  <p className="mb-4 leading-relaxed">
