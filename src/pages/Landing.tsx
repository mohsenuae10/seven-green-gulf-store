      ...
      <div className={`min-h-screen bg-gradient-to-b from-primary/5 via-background to-background ${language === 'ar' ? 'rtl' : 'ltr'}`}>
        ...
        <section className="pt-24 pb-16 px-4 bg-gradient-to-b from-primary/5 to-background" itemScope itemType="https://schema.org/Product">
          <div className="container mx-auto max-w-6xl">
            ...
            {/* Product Card */}
            <Card className="max-w-3xl mx-auto overflow-hidden border-2 border-primary/20 shadow-2xl bg-gradient-to-br from-background via-background to-primary/5">
              <CardContent className="p-0">
                <div className="grid md:grid-cols-2 gap-0">
                  {/* Product Image */}
                  <div className="relative bg-gradient-to-br from-primary/10 via-primary/5 to-background p-8 flex items-center justify-center">
                    <div className="absolute top-4 right-4 z-10">
                      <Badge className="bg-gradient-to-r from-destructive to-destructive/80 text-white px-3 py-1.5 text-sm font-bold shadow-lg">
                        -50%
                      </Badge>
                    </div>
                    <img 
                      src="/lovable-uploads/seven-green-product-email.png" 
                      alt={language === 'ar' ? 'منتج سفن جرين' : 'Seven Green product'}
                  ...
                  <div className="p-8 flex flex-col justify-center">
                    ...
                    <div className="space-y-3 mb-6">
                      {[
                        { ar: 'منتج طبيعي 100%', en: '100% Natural Product' },
                        { ar: 'معتمد طبياً', en: 'Medically Approved' },
                        { ar: 'نتائج ملحوظة', en: 'Noticeable Results' },
                        { ar: 'ضمان استرجاع المال', en: 'Money-Back Guarantee' }
                      ].map((item, idx) => (
                    ...
                    <Button 
                      size="lg" 
                      className="w-full text-lg py-6 shadow-lg hover:shadow-xl transition-all mb-4"
